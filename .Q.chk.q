.Q.chk:{f:{`/:'x,'d@&(d:!x)like"[0-9]*"}; d@:>.:'$last'`\:'d:$[`par.txt in!x;,/f'-1!'`$0:`/:x,`par.txt;f x];
 {[e;u;d]u[i]{.[x;(y;`);:;?[z;();0b;()]]}[d]'e i:&~u in!d}[d[(+u in/:t)?\:1b](0#.)'u,'`;u:?,/t:!:'d]'d}


Восстанавливает отсутствующие таблицы во ВСЕХ партициях HDB.
...
.[`:hdb/2020.01.03;`t3`;:;([] c3:1 2 3j)]    / `:hdb/2020.01.02/t2/ set ([] c2:4 5 6i)
